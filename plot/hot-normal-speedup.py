...
def ReadFile():
  ...
  bounds = []
  partitions = []
  with open('hot-normal-speedup.csv') as csvfile:
...
if __name__ == "__main__":
  ...
  DrawFigure(parameters, lines, legend_labels, 'Parameters', 'QPS [W/s]', 0, 10
, 0.8, 2, figure_folder, 'hot-normal-speedup', True)
